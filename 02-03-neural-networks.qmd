...
- For anti-phase: lag ≈ half the cycle period
...
- ✅ **Synapse types**: Electrical (gap junctions) vs diffusion (chemical-like)
- ✅ **Building networks**: From simple chains to all-to-all connectivity
- ✅ **Visualization**: Raster plots and population firing rates
- ✅ **Synchronization**: How coupling strength affects coordination
- ✅ **Central Pattern Generators**: Intrinsic rhythms from reciprocal coupling
- ✅ **Network analysis**: IBIs, phase relationships, and temporal patterns
