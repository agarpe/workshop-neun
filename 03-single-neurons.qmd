...
```{.python filename="src/subthreshold-responses.py"}
{{< include src/subthreshold-responses.py >}}
```

### Spike Generation

```{.python filename="src/spike-generation.py"}
{{< include src/spike-generation.py >}}
```
...
```{.python filename="src/fr-i-curve.py"}
{{< include src/fr-i-curve.py >}}
```
