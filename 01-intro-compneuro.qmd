...
![Action Potential Propagation](https://upload.wikimedia.org/wikipedia/commons/transcoded/2/23/Neuron_action_potential.webm/Neuron_action_potential.webm.1080p.vp9.webm?download){width=80%}

*Video showing action potential propagation through a neuron. Source: Wikimedia Commons*

### The Neuron as an Electrical Circuit

A neuron can be modelled as an electrical circuit with:

::: {.grid style="align-items: center;" .center}
::: {.g-col-3}
...
:::
::: {.g-col-6}
![](https://upload.wikimedia.org/wikipedia/commons/thumb/a/a6/Cable_theory_Neuron_RC_circuit_v2.svg/576px-Cable_theory_Neuron_RC_circuit_v2.svg.png?20170623201344){width=100%}
:::
:::
...
## From Neurons to Networks: Sinapses

### Why networks natter

Individual neurons are limited in their computational capabilities. Complex nervous functions emerge from **networks** of interconnected neurons.
