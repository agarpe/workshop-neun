---
title: "Part 4: Building Neural Networks"
...
```python
# Synaptic parameters
g_EE = 0.01  # E→E strength
g_EI = 0.02  # E→I strength  
g_IE = 0.05  # I→E strength
g_II = 0.02  # I→I strength
...
# plot_connectivity(syn_EE, 'E→E Connections')
```
...
- ✅ Creating multi-population networks
- ✅ Adding synaptic connections
- ✅ Simulating network dynamics
- ✅ Visualizing network activity (rasters, rates)
- ✅ Generating network oscillations
- ✅ Feedforward architectures
- ✅ Recurrent networks and persistent activity
- ✅ Analyzing network behavior
...
👉 **Continue to [Part 5: Advanced Topics](05-advanced-topics.qmd)**
